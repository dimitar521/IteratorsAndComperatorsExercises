...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, FamilyTree.Person> byNamePerson = new LinkedHashMap<>();
        ...
        while (!"End".equals(input = scan.nextLine())) {
            ...
            if (!input.contains(" - ")) {
                ...
                FamilyTree.Person person = new FamilyTree.Person(name, birthday);
        ...
        for (String inputLine : inputData) {
            ...
            if (!parent.contains("/")) {
                ...
                for (FamilyTree.Person personToFind : byNamePerson.values()) {
    ...
    private static String getInfo(Map<String, FamilyTree.Person> map, String someInfo) {
        String output="";

        if(!someInfo.contains("/")){
            output = someInfo + " " + map.get(someInfo).getBirthday();
        } else {
            for (FamilyTree.Person personToFind : map.values()) {
